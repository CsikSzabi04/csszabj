    ...
    <div className="text-gray-100 font-sans antialiased">
      <header className="fixed w-full z-50 bg-opacity-20 backdrop-filter backdrop-blur-sm shadow-lg">
        <div className="container mx-auto px-4 py-3">
          ...
          <div
            id="mobile-menu"
            className={`md:hidden absolute top-16 left-0 right-0 bg-gray-800 p-4 rounded-lg shadow-xl transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4 pointer-events-none'
              }`}
          >
