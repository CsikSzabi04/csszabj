    ...
    <section id="home" className="section min-h-screen w-full flex-shrink-0">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 flex flex-col-reverse md:flex-row items-center min-h-screen">
        ...
        <div className="w-full md:w-1/2 mt-10 md:mt-0 text-center md:text-left">
          ...
          {/* Social Icons */}
          <div className="mt-6 sm:mt-10 flex justify-center md:justify-start space-x-6 fade-in delay-400">
        ...
        {/* Right image */}
        <div className="w-full md:w-1/2 flex justify-center mb-8 md:mb-0 fade-in delay-500">
          <img
            src="011.png"
            alt="Szabolcs Csík"
